...
//Register.do?cmd=registerlist 회원목록 (cmd가 판단 근거)
//register.do 회원가입
...
public class RegisterFrontController extends HttpServlet {
    ...
    private void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	//추가 코드
    	ActionForward forward = null;  //redirect와 path 정보를 갖는 클래스 
    	Action action = null; //action인터페이스 타입은 모든 자식 객체의 주소값을 가질 수 있다
    	// 

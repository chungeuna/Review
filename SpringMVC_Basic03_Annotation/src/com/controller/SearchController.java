...
public class SearchController {
	...
	방법_3 : 편하게 (객체단위로 처리)  >> 유효성체크를 뷰단에서 한다 > 주로 2,3번 방법 쓴다 
	...
	방법_4 : @RequestParam Annotation   > validation 가능 
	유효성 처리 , 기본값 설정
	...
	*/
	...
	public ModelAndView searchInternal(@RequestParam("query") String query,
	 ...
	 reqeustParam() >클라이언트가 서버쪽에서 전송한 파라미터 이름 
	*/
	...
	public ModelAndView searchInternal(
			@RequestParam(value="query" , required=false) String query, //required=true인데 값이 없으면 400 잘못된 요청이라고 뜬다 

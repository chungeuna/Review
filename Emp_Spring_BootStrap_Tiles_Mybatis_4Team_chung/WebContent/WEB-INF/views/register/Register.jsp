                                        ...
                                        <form action="RegisterOk.do" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-label-group">
                                                        	<!--  <select id="job" name="job" style="height : 49px">
                                                        	 <option hidden>직종 선택</option>                                                          
                                                             </select> -->
                                                             <input type="text" id="job" name="job" class="form-control" placeholder="직종선택" required="required">
                                                            <label for="job"></label>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <div class="form-row">
                                                   ...
                                                   <!--          <select id="deptSelect" name="deptno" style="height : 49px">
                                                            ...
                                                            <input type="number" id="deptno" name="deptno" class="form-control" placeholder="부서 선택" required="required">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        Manager 
                                                            ...
                                                            <input type="text" id="mgr" name="mgr" class="form-control" placeholder="매니저 선택" required="required">
                                                        <label for="mgr"></label>
                                                        </div>
                                                    </div>
                                                </div>
